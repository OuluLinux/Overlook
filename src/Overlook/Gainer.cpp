...
void Gainer::StartEA(int pos) {
	...
	/*if (AccountNumber() != gi_76 && !IsDemo()) {
	   Comment("Ñîâåòíèê ìîæåò ðàáîòàòü òîëüêî íà ñ÷¸òå " + gi_76 + ", äëÿ áåñïëàòíîãî ïîäêëþ÷åíèÿ ê äðóãîìó ñ÷¸òó ïåðåéäèòå íà ñàéò invest-system.net");
	   return;
	}*/
...
int Gainer::OpOrd(String a_symbol_0, int a_cmd_8, double a_lots_12, double a_price_20, double a_price_28, double a_price_36, int a_magic_44) {
	int l_ticket_52;
	l_ticket_52 = OrderSend(a_symbol_0, a_cmd_8, a_lots_12, a_price_20, 6, a_price_28, a_price_36, gsa_412[g_index_400] + " MGK-" + a_magic_44 + " òîðã.ñë.¹" + g_index_400, a_magic_44);
	return (l_ticket_52);
}

double Gainer::UB(int ai_0, int ai_4) {
	double ld_8 = 0;
	double ld_16 = 0;
...
double Gainer::U0(int ai_0, int ai_4) {
	double ld_8 = 0;
	double ld_16 = 0;
	double ld_24 = 0;
	double ld_32 = 0;
...
int Gainer::MIN(int ai_0, int ai_4) {
	int li_ret_16;
	double ld_8 = 1000;
...
int Gainer::MAX(int ai_0, int ai_4) {
	int li_ret_16;
	double ld_8 = 0;
...
int Gainer::NOV(int ai_0, int ai_4, double ad_8) {
	int li_ret_24;
	double ld_16 = 1000;
...
int Gainer::NON(int ai_0, int ai_4, double ad_8) {
	int li_ret_24;
	double ld_16 = 0;
...
double Gainer::GetProfitForDay(int ai_0) {
	double ld_ret_4 = 0;
