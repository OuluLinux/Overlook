...
void HugeMonaAgent::SetArguments(const VectorMap<String, Value>& args) {
	
}

void HugeMonaAgent::Init() {
	TimeVector& tv = GetTimeVector();
...
void HugeMonaAgent::Forward(const SlotProcessAttributes& attr) {
...
void HugeMonaAgent::Backward(const SlotProcessAttributes& attr) {
