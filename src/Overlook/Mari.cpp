...
void Mari::AccountAndSymbolLbls() {
	...
	if (l_leverage_88 > 0.0)
		ld_48 = l_lotsize_40 / l_leverage_88;
	...
	if (ld_56 > 0.0 && l_free_magrin_32 > 0.0)
		ld_112 = l_free_magrin_32 / ld_56;
		
	if (ld_64 > 0.0 && l_free_magrin_32 > 0.0)
		ld_120 = l_free_magrin_32 / ld_64;
	...
	if (l_minlot_128 > 0.0)
		li_136 = ld_112 / l_minlot_128;
		
	bool li_140 = false;
	
	if (l_minlot_128 > 0.0)
		li_140 = ld_120 / l_minlot_128;
	...
	if (l_minlot_128 > 0.0)
		ld_152 = MarketInfo(ls_0, MODE_SWAPLONG) / l_minlot_128;
		
	double ld_160 = 0;
	
	if (l_minlot_128 > 0.0)
		ld_160 = MarketInfo(ls_0, MODE_SWAPSHORT) / l_minlot_128;
		
	double ld_168 = 0;
	
	if (l_tickvalue_144 > 0.0)
		ld_168 = ld_152 / l_tickvalue_144;
		
	double ld_176 = 0;
	
	if (l_tickvalue_144 > 0.0)
		ld_176 = ld_160 / l_tickvalue_144;
