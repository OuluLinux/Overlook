...
public class StartPointSeekBar extends View {
    ...
    private static final float DEFAULT_MIN_VALUE = -4;
    private static final float DEFAULT_MAX_VALUE = +4;
    ...
    private double normalizedThumbValue = 0.5d;
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (action & MotionEvent.ACTION_MASK) {
            ...
            case MotionEvent.ACTION_DOWN:
                ...
                if (!isThumbPressed) {
                    setNormalizedValue(screenToNormalized(mDownMotionX));
                }
    ...
    private void setNormalizedValue(double value) {
        ...
        int i = (int)normalizedToValue(normalizedThumbValue);
        normalizedThumbValue = valueToNormalized(i);
