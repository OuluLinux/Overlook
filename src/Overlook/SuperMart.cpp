...
void SuperMart::StartEA(int pos) {
	int l_stoplevel_8;
	int l_spread_12;
	double l_point_16;
	double l_bid_24;
...
int SuperMart::OpOrd(String a_symbol_0, int a_cmd_8, double a_lots_12, double a_price_20, double a_price_28, double a_price_36, int a_magic_44) {
	int l_ticket_52;
...
double SuperMart::UB(int ai_0, int ai_4) {
	double ld_8 = 0;
	double ld_16 = 0;
...
double SuperMart::U0(int ai_0, int ai_4) {
	double ld_8 = 0;
	double ld_16 = 0;
	double ld_24 = 0;
	double ld_32 = 0;
...
int SuperMart::MIN(int ai_0, int ai_4) {
	int li_ret_16;
	double ld_8 = 1000;
...
int SuperMart::MAX(int ai_0, int ai_4) {
	int li_ret_16;
	double ld_8 = 0;
...
int SuperMart::NOV(int ai_0, int ai_4, double ad_8) {
	int li_ret_24;
	double ld_16 = 1000;
...
int SuperMart::NON(int ai_0, int ai_4, double ad_8) {
	int li_ret_24;
	double ld_16 = 0;
...
void SuperMart::N() {
	...
	gia_528[g_index_400] = order_count;
	gia_516[g_index_400] = l_count_16;
	gia_520[g_index_400] = l_count_20;
}

double SuperMart::GetProfitForDay(int ai_0) {
	double ret = 0;
	...
	for (int l_pos_12 = 0; l_pos_12 < OrdersHistoryTotal(); l_pos_12++) {
		...
		if (OrderSymbol() == gsa_412[g_index_400] && OrderMagicNumber() == gia_432[0] || OrderMagicNumber() == gia_432[1] || OrderMagicNumber() == gia_432[2])
			if (OrderCloseTime() >= today && OrderCloseTime() < today + 86400)
				ret = ret + OrderProfit() + OrderCommission() + OrderSwap();
	}
